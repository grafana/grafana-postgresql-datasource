// This file contains a copy of tests for sqlmacro.SplitTrailingSQLCommenter from
// grafana/grafana (added in https://github.com/grafana/grafana/pull/127894) and
// will be removed after migrating to macropro v1.0.2.
package sqleng
