...
func TestIntegrationPostgres(t *testing.T) {
	...
	p, exe, err := newPostgres(t.Context(), "error", 10000, 0, dsInfo, cnnstr, logger, backend.DataSourceInstanceSettings{})
	...
	t.Run("Given a table with event data", func(t *testing.T) {
		...
		t.Run("When row limit set to 1", func(t *testing.T) {
			...
			_, handler, err := newPostgres(t.Context(), "error", 1, 0, dsInfo, cnnstr, logger, backend.DataSourceInstanceSettings{})
	...
	t.Run("Test Postgres connection with pgpass file", func(t *testing.T) {
		...
		pgpassPool, _, err := newPostgres(t.Context(), "error", 10000, 0, dsInfo, cnnstr, logger, backend.DataSourceInstanceSettings{})
		require.NoError(t, err)
